...
本项目是 exact_fire 的 H7 平台演进版，精简为**纯弹射击球系统**。相比 F4 版本去掉了底盘控制和遥控器，改为蓝牙无线指令触发，电机方案也从 RobStride+CAN 升级为**宇树 GoMotor+RS485 直驱**。

| 子系统 | 硬件 | 通信 | 控制方式 |
|--------|------|------|----------|
| 弹射臂 | 宇树 GoMotor | RS485 (UART2) | MIT 模式 (位置+速度+力矩+阻抗) |
| 指令输入 | 蓝牙模块 | UART7 (DMA) | 0xAA-cmd-0x55 协议 |
| 辅助电机 | DM-H6215 | FDCAN1/2 | 位置+速度 |
...
RS485 (USART2) 和蓝牙 (UART7) 都有独立的错误恢复逻辑：
